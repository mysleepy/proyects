...
namespace MySleepy
{
    public partial class PrincipalForm : Form
    {
        ...
        private void usuariosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (idRol == 1 || idRol == 2)
            {
                UsuariosForm usuarios = new UsuariosForm(idRol,conexion,idUsuario);
        ...
        {
            ArticulosForm articulos = new ArticulosForm(idRol, conexion,idUsuario);
        ...
        {
            PedidosForm pedidos = new PedidosForm(idRol, conexion,idUsuario);
        ...
        private void historialToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            HistorialForm historial = new HistorialForm(idUsuario,conexion);
