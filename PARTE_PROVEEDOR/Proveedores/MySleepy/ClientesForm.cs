...
namespace MySleepy
{
    public partial class ClientesForm : Form
    {
        ...
        private void tooltip()
        {
            ...
            toolTip1.SetToolTip(this.btnBorrar, "Borrar Cliente");
            toolTip1.SetToolTip(this.btnRestaurar, "Restaurar Cliente");
        }       
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            else { MessageBox.Show("No se puede modificar un cliente eliminado"); }
        }
        /// <summary>
        /// Boton Resaturar
        /// </summary>
