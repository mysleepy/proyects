...
namespace MySleepy
{
    public partial class AddNuevoArticulo : Form
    {
        ...
        private void txtNombre_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (!Char.IsLetter(e.KeyChar) || Char.IsWhiteSpace(e.KeyChar) || e.KeyChar.Equals("\'"))
            {
                e.Handled = true;
            }
        ...
        {
            if (Char.GetNumericValue(e.KeyChar) == -1 || Char.IsPunctuation(e.KeyChar) || e.KeyChar.Equals("\'"))
            {
                e.Handled = false;
                return;
            }
